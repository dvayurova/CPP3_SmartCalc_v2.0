...
TEST(ModelTest, Case1) {
  ...
  ASSERT_DOUBLE_EQ(1225.9, model.GetResult().second);
}

TEST(ModelTest, Case2) {
  std::string expression = "-2^2^2^(-4/5) ";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(-0.1088188204120155, model.GetResult().second);
}

TEST(ModelTest, Case3) {
  std::string expression = "2.5 - 0.5";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(2.0, model.GetResult().second);
}

TEST(ModelTest, Case4) {
  std::string expression = "-1.9 + (-777.1)";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(-779, model.GetResult().second);
}

TEST(ModelTest, Case5) {
  std::string expression = "-2.12345 - 1000.000003";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(-1002.123453, model.GetResult().second);
}

TEST(ModelTest, Case6) {
  std::string expression = "-2.78941 - (-995.258964)";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(992.469554, model.GetResult().second);
}

TEST(ModelTest, Case7) {
  std::string expression = "100000 - (-20249.654684)";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(120249.654684, model.GetResult().second);
}

TEST(ModelTest, Case8) {
  std::string expression = "122.1 * 82327.9";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(10052236.59, model.GetResult().second);
}

TEST(ModelTest, Case9) {
  std::string expression = "-1.9 * (-13227.1)";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(25131.49, model.GetResult().second);
}
...
TEST(ModelTest, Case10) {
  std::string expression =
      "1                        +                       0.4";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(1.4, model.GetResult().second);
}

TEST(ModelTest, Case11) {
  std::string expression = "25 / 5";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(5, model.GetResult().second);
}

TEST(ModelTest, Case12) {
  std::string expression = "22^3";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(10648, model.GetResult().second);
}

TEST(ModelTest, Case13) {
  std::string expression = "10 mod 3";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(1, model.GetResult().second);
}

TEST(ModelTest, Case14) {
  std::string expression = "cos(30)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.154251449888, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case15) {
  std::string expression = "sin(45)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.850903524534, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case16) {
  std::string expression = "tan(90)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(-1.995200412208, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case17) {
  std::string expression = "acos(-0.3)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(1.8754889, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case18) {
  std::string expression = "asin(0.5)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.5235988, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case19) {
  std::string expression = "atan(1)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.7853981, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case20) {
  std::string expression = "sqrt(9)";
  s21::CalculatorModel model(expression);
  ASSERT_DOUBLE_EQ(3, model.GetResult().second);
}

TEST(ModelTest, Case21) {
  std::string expression = "ln(99)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(4.5951198, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case22) {
  std::string expression = "log(100)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(2, model.GetResult().second, 1e-6);
}
...
TEST(ModelTest, Case23) {
  std::string expression =
      ...
      "(-458.3258)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(-63815.9261298373886, model.GetResult().second, 1e-6);
}
...
TEST(ModelTest, Case24) {
  ...
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(-2.666278232473545, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case25) {
  std::string expression = "log(2) + (-1/2) * log(8) - ln(4 * sqrt(8))";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(-2.57653012979, model.GetResult().second, 1e-6);
}
...
TEST(ModelTest, Case26) {
  ...
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.49956901475, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case27) {
  std::string expression = "sin(cos(ln(sqrt(4))))";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.69558863622, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case28) {
  std::string expression = "-1.0/(-3.0)";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(0.3333333333333333, model.GetResult().second, 1e-6);
}
...
TEST(ModelTest, Case29) {
  ...
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(3.31540708, model.GetResult().second, 1e-6);
}

TEST(ModelTest, Case30) {
  std::string expression = "(2^8 + 2^(-5))*(sqrt(144)/(-2))";
  s21::CalculatorModel model(expression);
  ASSERT_NEAR(-1536.1875, model.GetResult().second, 1e-6);
}
